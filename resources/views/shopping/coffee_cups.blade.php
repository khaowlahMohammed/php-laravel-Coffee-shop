...
<div class="container" dir="rtl">
    <div class="row justify-content-center mb-5">
        <div class="col-md-6 text-center">
            <h3 class="alert alert-success">أكواب القهوة</h3>
        </div>
    </div>
    <div class="row">
        @foreach($products as $item)
            <div class="col-md-4 mt-3 d-flex align-items-stretch">
                <div class="card h-100 shadow-sm">
                    <img src='https://www.restaurantware.com/cdn/shop/files/RWA0302W-L2-LR.jpg?v=1727951707&width=300' class="card-img-top"  style="height: 250px; object-fit: cover;">
                    <div class="card-body">
